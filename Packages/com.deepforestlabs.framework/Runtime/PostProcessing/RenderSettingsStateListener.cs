...
{
    [Serializable]
    public class RenderSettingsStateListener : StateMachineBehaviour
    {
        ...
        [SerializeField]
        [HideInInspector]
        private RenderSettingsProfile? _enterProfile = null;
        ...
        [SerializeField]
        [HideInInspector]
        private RenderSettingsProfile? _exitProfile = null;
        ...
        public override void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
        {
            ...
            {
                RenderController.TransitionRenderSettings(_enterProfile);
            }
            else
            {
                RenderController.LoadRenderSettingsProfile(_enterProfile);
            }
        }
        ...
        public override void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
        {
            ...
            {
                RenderController.TransitionRenderSettings(_exitProfile);
            }
            else
            {
                RenderController.LoadRenderSettingsProfile(_exitProfile);
            }
        }
    }
}
