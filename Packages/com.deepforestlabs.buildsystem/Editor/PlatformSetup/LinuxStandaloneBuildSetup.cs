...
{
    public sealed class LinuxStandaloneBuildSetup : IPlatformBuildSetup
    {
        ...
        public string GetOutputPath(CommandLineArgs args, string baseBuildPath)
        {
            ...
            string fileName = ZString.Format("{0}_{1}_{2}_{3}.x86_64", productName, args.UniqueId, args.BuildNumber, args.Environment.ToLower());
