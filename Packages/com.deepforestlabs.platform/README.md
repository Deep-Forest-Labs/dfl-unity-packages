...
`Firebase` requires the game to install Firebase Unity App + Analytics + Remote Config (+ Auth for E6 account) packages and commit `google-services.json` / `GoogleService-Info.plist`. See [docs/platform.md](../../docs/platform.md) and ghostgarden `ci/firebase.md`.
